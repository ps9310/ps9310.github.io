...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1378: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1379: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1380: (x0,x1) => x0.createElement(x1),
      _1381: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1383: (x0,x1) => x0.getAttribute(x1),
      ...
      _1411: () => new Error().stack,
      _1412: () => typeof dartUseDateNowForTicks !== "undefined",
      _1413: () => 1000 * performance.now(),
      _1414: () => Date.now(),
      _1415: () => {
      ...
      _1417: () => new WeakMap(),
      _1418: (map, o) => map.get(o),
      _1419: (map, o, v) => map.set(o, v),
      _1420: (exn) => exn.toString(),
      _1421: (exn) => exn.stack,
      _1422: (exn) => {
      ...
      _1437: (o, p, r) => o.replaceAll(p, () => r),
      _1438: (o, p, r) => o.replace(p, () => r),
      _1439: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1440: s => s.toUpperCase(),
      _1441: s => s.trim(),
      _1442: s => s.trimLeft(),
      _1443: s => s.trimRight(),
      _1444: (string, times) => string.repeat(times),
      _1445: Function.prototype.call.bind(String.prototype.indexOf),
      _1446: (s, p, i) => s.lastIndexOf(p, i),
      _1447: (string, token) => string.split(token),
      _1448: Object.is,
      ...
      _1587: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1587(f,arguments.length,x0,x1) }),
      _1588: o => {
      ...
      _1589: o => [o],
      _1590: (o0, o1) => [o0, o1],
      _1591: (o0, o1, o2) => [o0, o1, o2],
      _1592: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1641: x0 => x0.abort(),
      _1642: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1643: (x0,x1) => globalThis.fetch(x0,x1),
      _1644: (x0,x1) => x0.get(x1),
      _1645: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1645(f,arguments.length,x0,x1,x2) }),
      _1646: (x0,x1) => x0.forEach(x1),
      _1647: x0 => x0.getReader(),
      _1649: (x0,x1) => x0.key(x1),
      _1650: o => o instanceof Array,
      _1651: (a, i) => a.push(i),
      _1652: (a, i) => a.splice(i, 1)[0],
      _1655: a => a.pop(),
      _1656: (a, i) => a.splice(i, 1),
      _1657: (a, s) => a.join(s),
      _1658: (a, s, e) => a.slice(s, e),
      _1660: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1661: a => a.length,
      _1663: (a, i) => a[i],
      _1664: (a, i, v) => a[i] = v,
      _1666: o => {
      ...
      _1669: o => o instanceof Uint8Array,
      _1670: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1671: o => o instanceof Int8Array,
      _1672: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1673: o => o instanceof Uint8ClampedArray,
      _1674: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1675: o => o instanceof Uint16Array,
      _1676: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1677: o => o instanceof Int16Array,
      _1678: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1679: o => o instanceof Uint32Array,
      _1680: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1681: o => o instanceof Int32Array,
      _1682: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1684: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1685: o => o instanceof Float32Array,
      _1686: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1687: o => o instanceof Float64Array,
      _1688: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1689: (t, s) => t.set(s),
      _1690: l => new DataView(new ArrayBuffer(l)),
      _1691: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1693: o => o.buffer,
      _1694: o => o.byteOffset,
      _1695: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1696: (b, o) => new DataView(b, o),
      _1697: (b, o, l) => new DataView(b, o, l),
      _1698: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1699: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1700: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1701: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1702: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1703: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1704: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1705: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1706: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1707: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1708: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1709: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1712: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1713: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1714: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1715: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1716: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1717: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1718: Function.prototype.call.bind(Number.prototype.toString),
      _1719: Function.prototype.call.bind(BigInt.prototype.toString),
      _1720: Function.prototype.call.bind(Number.prototype.toString),
      _1721: (d, digits) => d.toFixed(digits),
      ...
      _1908: x0 => x0.style,
      _3589: (x0,x1) => { x0.dropEffect = x1 },
      _3590: x0 => x0.effectAllowed,
      _3592: x0 => x0.items,
      _3593: x0 => x0.types,
      _3595: (x0,x1) => x0[x1],
      _3599: x0 => x0.length,
      _3600: x0 => x0.kind,
      _3601: x0 => x0.type,
      _3603: x0 => x0.dataTransfer,
      _3607: () => globalThis.window,
      ...
      _8729: x0 => x0.body,
      _8804: x0 => x0.types,
      _11111: (x0,x1) => { x0.cursor = x1 },
      _11121: (x0,x1) => { x0.display = x1 },
      _11285: (x0,x1) => { x0.height = x1 },
      _11497: (x0,x1) => { x0.opacity = x1 },
      _11975: (x0,x1) => { x0.width = x1 },
      _12343: x0 => x0.name,
